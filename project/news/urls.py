...
urlpatterns = [
   ...
   path('post/<int:post_id>/category/<int:category_id>/subscribe', subscribe_category, name='subscribe'),
   path('post/<int:post_id>/author/<int:author_id>/subscribe', subscribe_author, name='subscribe'),
